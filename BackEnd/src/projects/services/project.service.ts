  ...
  async createProject(orgId: string, userId: string, data: CreateProjectDto) {
    try {
      ...
      const newProject = new this.projectModel({
        organizationId: new (Types.ObjectId as any)(String(orgId)),
        createdBy: new (Types.ObjectId as any)(String(userId)),
      ...
      const firstEvent = new this.timelineEventModel({
        ...
        organizationId: new (Types.ObjectId as any)(String(orgId)),
        authorId: new (Types.ObjectId as any)(String(userId)),
  ...
  async bulkImportProjects(orgId: string, userId: string, projectsData: any[]) {
    try {
      ...
      for (const data of projectsData) {
        ...
        const projectId = new (Types.ObjectId as any)(); // Gera o ID antes de salvar para linkar com a Timeline
